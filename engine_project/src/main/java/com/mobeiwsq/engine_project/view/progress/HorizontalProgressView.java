...
package com.mobeiwsq.engine_project.view.progress;
...
public class HorizontalProgressView extends View {
     ...
     */
    private int mStartColor = getResources().getColor(R.color.config_color_light_orange);
    /**
     * the color of end progress
     */
    private int mEndColor = getResources().getColor(R.color.config_color_dark_orange);
    /**
    ...
    private void obtainAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mStartColor = typedArray.getColor(R.styleable.HorizontalProgressView_hpv_start_color, getResources().getColor(R.color.config_color_light_orange));
        mEndColor = typedArray.getColor(R.styleable.HorizontalProgressView_hpv_end_color, getResources().getColor(R.color.config_color_dark_orange));
        ...
        if (textVisibility) {
            ...
            if (isTextMoved) {
                canvas.drawText(progressText,
                        (getWidth() - getPaddingLeft() - getPaddingRight() - dp2px(getContext(), 28)) * (moveProgress / 100) + dp2px(getContext(), 10),
    ...
    public void setTrackWidth(int width) {
        this.mTrackWidth = dp2px(getContext(), width);
        refreshTheView();
    }
    ...
    public void setProgressTextSize(int size) {
        mProgressTextSize = sp2px(getContext(), size);
        refreshTheView();
    }
    ...
    public void setProgressCornerRadius(int radius) {
        this.mCornerRadius = dp2px(getContext(), radius);
        refreshTheView();
    }
    ...
    public void setProgressTextPaddingBottom(int offset) {
        this.mTextPaddingBottomOffset = dp2px(getContext(), offset);
    }
