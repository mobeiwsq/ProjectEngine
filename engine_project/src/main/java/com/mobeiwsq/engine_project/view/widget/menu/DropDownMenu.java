package com.mobeiwsq.engine_project.view.widget.menu;
...
import static com.mobeiwsq.engine_project.utils.ThemeUtils.getMainThemeColor;
import static com.mobeiwsq.engine_project.utils.Utils.*;
...
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mDividerColor = array.getColor(R.styleable.DropDownMenu_ddm_dividerColor, ThemeUtils.resolveColor(getContext(), R.attr.config_color_separator_dark));
        mDividerWidth = array.getDimensionPixelSize(R.styleable.DropDownMenu_ddm_dividerWidth, getDimensionPixelSize(context, R.dimen.default_ddm_divider_width));
        mDividerMargin = array.getDimensionPixelSize(R.styleable.DropDownMenu_ddm_dividerMargin, getDimensionPixelSize(context, R.dimen.default_ddm_divider_margin));
        int underlineColor = array.getColor(R.styleable.DropDownMenu_ddm_underlineColor, ThemeUtils.resolveColor(context, R.attr.config_color_separator_light));
        int underlineHeight = array.getDimensionPixelSize(R.styleable.DropDownMenu_ddm_underlineHeight, getDimensionPixelSize(context, R.dimen.default_ddm_underline_height));
        int menuBackgroundColor = array.getColor(R.styleable.DropDownMenu_ddm_menuBackgroundColor, Color.WHITE);
        mMaskColor = array.getColor(R.styleable.DropDownMenu_ddm_maskColor, getColor(context, R.color.default_ddm_mask_color));
        mMenuTextSelectedColor = array.getColor(R.styleable.DropDownMenu_ddm_menuTextSelectedColor, getMainThemeColor(context));
        mMenuTextUnselectedColor = array.getColor(R.styleable.DropDownMenu_ddm_menuTextUnselectedColor, resolveColor(context, R.attr.config_color_content_text));
        mMenuTextPaddingHorizontal = array.getDimensionPixelSize(R.styleable.DropDownMenu_ddm_menuTextPaddingHorizontal, getDimensionPixelSize(context, R.dimen.default_ddm_menu_text_padding_horizontal));
        mMenuTextPaddingVertical = array.getDimensionPixelSize(R.styleable.DropDownMenu_ddm_menuTextPaddingVertical, getDimensionPixelSize(context, R.dimen.default_ddm_menu_text_padding_vertical));
        mMenuTextSize = array.getDimensionPixelSize(R.styleable.DropDownMenu_ddm_menuTextSize, getDimensionPixelSize(context, R.dimen.default_ddm_menu_text_size));
    ...
    public void setDropDownMenu(@NonNull List<String> tabTexts, @NonNull List<View> popupViews, @NonNull View contentView) {
        ...
        mPopupMenuViews.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) (DensityUtils.INSTANCE.getDisplayHeight(getContext(), true) * mMenuHeightPercent)));
