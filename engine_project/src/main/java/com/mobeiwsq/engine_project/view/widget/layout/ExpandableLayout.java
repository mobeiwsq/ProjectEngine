package com.mobeiwsq.engine_project.view.widget.layout;
...
import com.mobeiwsq.engine_project.view.widget.layout.interpolator.FastOutSlowInInterpolator;
...
public class ExpandableLayout extends FrameLayout {
    ...
    public ExpandableLayout(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            a.recycle();
            mState = mExpansion == 0 ? State.COLLAPSED : State.EXPANDED;
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        ...
        mState = mExpansion == 1 ? State.EXPANDED : State.COLLAPSED;
    ...
    public boolean isExpanded() {
        return mState == State.EXPANDING || mState == State.EXPANDED;
    }
    ...
    public void setExpansion(float expansion) {
        ...
        if (expansion == 0) {
            ...
            mState = State.COLLAPSING;
        } else if (delta > 0) {
            mState = State.EXPANDING;
        }
        setVisibility(mState == State.COLLAPSED ? GONE : VISIBLE);
    ...
    private class ExpansionListener implements Animator.AnimatorListener {
        ...
        public void onAnimationStart(Animator animation) {
            mState = targetExpansion == 0 ? State.COLLAPSING : State.EXPANDING;
        }

        @Override
        public void onAnimationEnd(Animator animation) {
            if (!canceled) {
                mState = targetExpansion == 0 ? State.COLLAPSED : State.EXPANDED;
                setExpansion(targetExpansion);
            }
        }
