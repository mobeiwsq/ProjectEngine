package com.mobeiwsq.engine_project.view.widget.text.supertextview;
...
import com.mobeiwsq.engine_project.view.widget.edittext.ClearEditText;
import com.mobeiwsq.engine_project.view.widget.edittext.PasswordEditText;
import io.github.inflationx.calligraphy3.HasTypeface;

import static com.mobeiwsq.engine_project.utils.ThemeUtils.getColor;
import static com.mobeiwsq.engine_project.utils.Utils.getDimensionPixelSize;
import static com.mobeiwsq.engine_project.utils.Utils.getDrawableAttrRes;
...
public class SuperTextView extends RelativeLayout implements HasTypeface {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mDefaultTextSize = ThemeUtils.resolveDimension(context, R.attr.stv_text_size, getDimensionPixelSize(context, R.dimen.default_stv_text_size));
        mDefaultMaxEms = ThemeUtils.resolveInt(context, R.attr.stv_max_ems, 20);
        mDefaultMargin = ThemeUtils.resolveDimension(context, R.attr.stv_margin, ResUtils.INSTANCE.getDimensionPixelSize(context, R.dimen.default_stv_margin));
        mDefaultShapeColor = ThemeUtils.resolveColor(context, R.attr.stv_color_shape, ContextCompat.getColor(context, R.color.config_color_white));
    ...
    private void getAttr(AttributeSet attrs) {
        ...
        mLeftTvDrawableLeft = ResUtils.INSTANCE.getDrawableAttrRes(getContext(), typedArray, R.styleable.SuperTextView_sLeftTvDrawableLeft);
        mLeftTvDrawableRight = ResUtils.INSTANCE.getDrawableAttrRes(getContext(), typedArray, R.styleable.SuperTextView_sLeftTvDrawableRight);
        mCenterTvDrawableLeft = ResUtils.INSTANCE.getDrawableAttrRes(getContext(), typedArray, R.styleable.SuperTextView_sCenterTvDrawableLeft);
        mCenterTvDrawableRight = ResUtils.INSTANCE.getDrawableAttrRes(getContext(), typedArray, R.styleable.SuperTextView_sCenterTvDrawableRight);
        mRightTvDrawableLeft = ResUtils.INSTANCE.getDrawableAttrRes(getContext(), typedArray, R.styleable.SuperTextView_sRightTvDrawableLeft);
        mRightTvDrawableRight = ResUtils.INSTANCE.getDrawableAttrRes(getContext(), typedArray, R.styleable.SuperTextView_sRightTvDrawableRight);
        ...
        mDividerLineColor = typedArray.getColor(R.styleable.SuperTextView_sDividerLineColor, ThemeUtils.resolveColor(getContext(), R.attr.config_color_separator_light));

        mDividerLineHeight = typedArray.getDimensionPixelSize(R.styleable.SuperTextView_sDividerLineHeight, DensityUtils.INSTANCE.dp2px(mContext, 0.5f));
        ////////////////////////////////////////////////
        ...
        ///////////////////////////////////////////////
        mLeftIconRes = getDrawableAttrRes(getContext(), typedArray, R.styleable.SuperTextView_sLeftIconRes);
        ...
        mLeftIconTint = ResUtils.INSTANCE.getColorStateListAttrRes(getContext(), typedArray, R.styleable.SuperTextView_sLeftIconTint);
        mLeftIconPadding = typedArray.getDimensionPixelSize(R.styleable.SuperTextView_sLeftIconPadding, 0);

        mRightIconRes = ResUtils.INSTANCE.getDrawableAttrRes(getContext(), typedArray, R.styleable.SuperTextView_sRightIconRes);
        ...
        mRightIconTint = ResUtils.INSTANCE.getColorStateListAttrRes(getContext(), typedArray, R.styleable.SuperTextView_sLeftIconTint);
        ...
        mLeftTextBackground = ResUtils.INSTANCE.getDrawableAttrRes(getContext(), typedArray, R.styleable.SuperTextView_sLeftTextBackground);
        mCenterTextBackground = ResUtils.INSTANCE.getDrawableAttrRes(getContext(), typedArray, R.styleable.SuperTextView_sCenterTextBackground);
        mRightTextBackground = ResUtils.INSTANCE.getDrawableAttrRes(getContext(), typedArray, R.styleable.SuperTextView_sRightTextBackground);

        ////////////////////////////////////////////////////

        mEnableEdit = typedArray.getBoolean(R.styleable.SuperTextView_sEnableEdit, mEnableEdit);
        mEditBackground = ResUtils.INSTANCE.getDrawableAttrRes(getContext(), typedArray, R.styleable.SuperTextView_sEditBackGround);
        ...
        mBackgroundDrawable = ResUtils.INSTANCE.getDrawableAttrRes(getContext(), typedArray, R.styleable.SuperTextView_sBackgroundDrawableRes);
        ///////////////////////////////////////////////
        ...
        mRightCheckBoxBg = ResUtils.INSTANCE.getDrawableAttrRes(getContext(), typedArray, R.styleable.SuperTextView_sRightCheckBoxRes);
        //////////////////////////////////////////////////
        ...
        mSwitchThumbResource = ResUtils.INSTANCE.getDrawableAttrRes(getContext(), typedArray, R.styleable.SuperTextView_sThumbResource);
        mSwitchTrackResource = ResUtils.INSTANCE.getDrawableAttrRes(getContext(), typedArray, R.styleable.SuperTextView_sTrackResource);

        mCenterSpaceHeight = typedArray.getDimensionPixelSize(R.styleable.SuperTextView_sCenterSpaceHeight, DensityUtils.INSTANCE.dp2px(mContext, 5));
        ////////////////////////////////////////////////////
    ...
    private void initCenterTextView() {
        if (mEnableEdit) {
            ...
            if (mEditBackground != null) {
                ...
                mCenterEditText.setBackgroundColor(getColor(getContext(), R.color.config_color_transparent));
            }
    ...
    public SuperTextView setShapeStrokeWidth(int strokeWidth) {
        mStrokeWidth = DensityUtils.INSTANCE.dp2px(mContext, strokeWidth);
        return this;
    }
    ...
    public SuperTextView setShapeSrokeDashWidth(float strokeDashWidth) {
        this.mStrokeDashWidth = DensityUtils.INSTANCE.dp2px(mContext, strokeDashWidth);
        return this;
    }
    ...
    public SuperTextView setShapeStrokeDashGap(float strokeDashGap) {
        this.mStrokeDashGap = DensityUtils.INSTANCE.dp2px(mContext, strokeDashGap);
        return this;
    }
    ...
    public SuperTextView setShapeCornersRadius(float radius) {
        this.mCornersRadius = DensityUtils.INSTANCE.dp2px(mContext, radius);
        return this;
    }
    ...
    public SuperTextView setShapeCornersTopLeftRadius(float radius) {
        this.mCornersTopLeftRadius = DensityUtils.INSTANCE.dp2px(mContext, radius);
        return this;
    }
    ...
    public SuperTextView setShapeCornersTopRightRadius(float radius) {
        this.mCornersTopRightRadius = DensityUtils.INSTANCE.dp2px(mContext, radius);
        return this;
    }
    ...
    public SuperTextView setShapeCornersBottomLeftRadius(float radius) {
        this.mCornersBottomLeftRadius = DensityUtils.INSTANCE.dp2px(mContext, radius);
        return this;
    }
    ...
    public SuperTextView setShapeCornersBottomRightRadius(float radius) {
        this.mCornersBottomRightRadius = DensityUtils.INSTANCE.dp2px(mContext, radius);
        return this;
    }
