package com.mobeiwsq.engine_project.view.widget.timer;
...
import com.mobeiwsq.engine_project.view.widget.BasePickerView;
import com.mobeiwsq.engine_project.view.widget.timer.configure.PickerOptions;
import com.mobeiwsq.engine_project.view.widget.timer.listener.ISelectTimeCallback;
import com.mobeiwsq.engine_project.view.widget.wheelview.WheelTime;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            if (isDialog()) {
                LayoutInflater.from(context).inflate(R.layout.layout_picker_view_time_dialog, contentContainer);
            } else {
                LayoutInflater.from(context).inflate(R.layout.layout_picker_view_time, contentContainer);
            }
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(mPickerOptions.textContentConfirm) ? context.getResources().getString(R.string.picker_view_submit) : mPickerOptions.textContentConfirm);
            btnCancel.setText(TextUtils.isEmpty(mPickerOptions.textContentCancel) ? context.getResources().getString(R.string.picker_view_cancel) : mPickerOptions.textContentCancel);
