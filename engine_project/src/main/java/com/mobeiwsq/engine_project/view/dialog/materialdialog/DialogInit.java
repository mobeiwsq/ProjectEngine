...
import com.mobeiwsq.engine_project.view.dialog.materialdialog.internal.MDAdapter;
...
import com.mobeiwsq.engine_project.view.progress.materialprogressbar.HorizontalProgressDrawable;
import com.mobeiwsq.engine_project.view.progress.materialprogressbar.IndeterminateCircularProgressDrawable;
import com.mobeiwsq.engine_project.view.progress.materialprogressbar.IndeterminateHorizontalProgressDrawable;
import com.mobeiwsq.engine_project.view.widget.KeyboardScrollView;
...
class DialogInit {
    ...
    public static void init(final MaterialDialog dialog) {
        ...
        over scroll glow without clipping */
                ...
                final ScrollView sv = new KeyboardScrollView(dialog.getContext());
        ...
        int windowVerticalPadding = ThemeUtils.resolveDimension(builder.context, R.attr.md_dialog_vertical_margin, ResUtils.INSTANCE.getDimensionPixelSize(builder.context, R.dimen.default_md_dialog_vertical_margin));
        int windowHorizontalPadding = ThemeUtils.resolveDimension(builder.context, R.attr.md_dialog_horizontal_margin, ResUtils.INSTANCE.getDimensionPixelSize(builder.context, R.dimen.default_md_dialog_horizontal_margin_phone));
