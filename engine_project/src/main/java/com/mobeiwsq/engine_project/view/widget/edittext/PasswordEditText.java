...
public class PasswordEditText extends AppCompatEditText {
    ...
    public void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        mExtraClickArea = DensityUtils.INSTANCE.dp2px(context, 20);
        ...
        try {
            mShowPwDrawable = ResUtils.INSTANCE.getDrawableAttrRes(getContext(), typedArray, R.styleable.PasswordEditText_pet_iconShow);
            if (mShowPwDrawable == null) {
                mShowPwDrawable = ResUtils.INSTANCE.getVectorDrawable(getContext(), R.drawable.pet_icon_visibility_24dp);
            }
            mHidePwDrawable = ResUtils.INSTANCE.getDrawableAttrRes(getContext(), typedArray, R.styleable.PasswordEditText_pet_iconHide);
            if (mHidePwDrawable == null) {
                mHidePwDrawable = ResUtils.INSTANCE.getVectorDrawable(getContext(), R.drawable.pet_icon_visibility_off_24dp);
            }
