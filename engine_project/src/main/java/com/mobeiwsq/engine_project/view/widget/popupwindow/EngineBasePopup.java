 ...
 *
 */
public abstract class EngineBasePopup {
     ...
     */
    public EngineBasePopup(Context context) {
        mContext = context;
    ...
    public void setContentView(View root) {
        ...
        mPopupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                EngineBasePopup.this.onDismiss();
     ...
     * @param listener
     */
    public EngineBasePopup setOnDismissListener(PopupWindow.OnDismissListener listener) {
    ...
    public class RootView extends FrameLayout {
        ...
        protected void onConfigurationChanged(Configuration newConfig) {
            ...
            EngineBasePopup.this.onConfigurationChanged(newConfig);
