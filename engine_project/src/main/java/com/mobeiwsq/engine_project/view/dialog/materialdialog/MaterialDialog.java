package com.mobeiwsq.engine_project.view.dialog.materialdialog;
...
import com.mobeiwsq.engine_project.utils.StatusBarUtils;
import com.mobeiwsq.engine_project.utils.ThemeUtils;
import com.mobeiwsq.engine_project.view.dialog.GravityEnum;
import com.mobeiwsq.engine_project.view.dialog.materialdialog.internal.MDButton;
import com.mobeiwsq.engine_project.view.dialog.materialdialog.internal.MDRootLayout;
import com.mobeiwsq.engine_project.view.dialog.materialdialog.internal.MDTintHelper;
import com.mobeiwsq.engine_project.view.dialog.materialdialog.internal.ThemeSingleton;
import com.mobeiwsq.engine_project.view.dialog.materialdialog.util.RippleHelper;
...
public class MaterialDialog extends DialogBase
    ...
    final Drawable getListSelector() {
        if (builder.listSelector != 0) {
            return ResUtils.INSTANCE.getDrawable(builder.context, builder.listSelector);
        }
    ...
    /* package */ Drawable getButtonSelector(DialogAction which, boolean isStacked) {
        if (isStacked) {
            if (builder.btnSelectorStacked != 0) {
                return ResUtils.INSTANCE.getDrawable(builder.context, builder.btnSelectorStacked);
            }
            final Drawable d =
            ...
            switch (which) {
                case NEUTRAL:
                    if (builder.btnSelectorNeutral != 0) {
                        return ResUtils.INSTANCE.getDrawable(builder.context, builder.btnSelectorNeutral);
                    }
                ...
                case NEGATIVE:
                    if (builder.btnSelectorNegative != 0) {
                        return ResUtils.INSTANCE.getDrawable(builder.context, builder.btnSelectorNegative);
                    }
                ...
                default:
                    if (builder.btnSelectorPositive != 0) {
                        return ResUtils.INSTANCE.getDrawable(builder.context, builder.btnSelectorPositive);
                    }
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context) {
            ...
            final String mediumFont = ThemeUtils.resolveString(context, R.attr.md_medium_font, EngineConfig.INSTANCE.getDefaultFontAssetPath());
            final String regularFont = ThemeUtils.resolveString(context, R.attr.md_regular_font, EngineConfig.INSTANCE.getDefaultFontAssetPath());
            try {
        ...
        public Builder typeface(@Nullable String medium, @Nullable String regular) {
            if (medium != null && !medium.trim().isEmpty()) {
                this.mediumFont = EngineConfig.INSTANCE.getDefaultTypeface(medium);
                if (this.mediumFont == null) {
                    throw new IllegalArgumentException("No font asset found for \"" + medium + "\"");
                }
            }
            if (regular != null && !regular.trim().isEmpty()) {
                this.regularFont = EngineConfig.INSTANCE.getDefaultTypeface(regular);
                if (this.regularFont == null) {
        ...
        public Builder iconRes(@DrawableRes int icon) {
            if (icon != -1) {
                this.icon = ResUtils.INSTANCE.getDrawable(context, icon);
            }
            return this;
        }
        ...
        public Builder inputRange(
            ...
            if (errorColor == 0) {
                this.inputRangeErrorColor = ThemeUtils.resolveColor(context, R.attr.config_color_error_text);
            } else {
