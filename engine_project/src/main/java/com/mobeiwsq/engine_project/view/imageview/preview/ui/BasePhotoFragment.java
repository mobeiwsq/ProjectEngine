...
import com.mobeiwsq.engine_project.view.imageview.photoview.PhotoViewAttacher;
...
import com.mobeiwsq.engine_project.view.imageview.preview.loader.OnVideoClickListener;
import com.mobeiwsq.engine_project.view.imageview.preview.view.SmoothImageView;
import com.mobeiwsq.engine_project.view.progress.materialprogressbar.MaterialProgressBar;
...
public class BasePhotoFragment extends Fragment {
     ...
     * 预览图片 类型
     */
    public static final String KEY_TRANS_PHOTO = "com.mobeiwsq.engine.widget.preview.KEY_TRANS_PHOTO";
    public static final String KEY_SING_FILING = "com.mobeiwsq.engine.widget.preview.KEY_SING_FILING";
    public static final String KEY_PREVIEW_ITEM = "com.mobeiwsq.engine.widget.preview.KEY_PREVIEW_ITEM";
    public static final String KEY_DRAG = "com.mobeiwsq.engine.widget.preview.KEY_DRAG";
    public static final String KEY_SENSITIVITY = "com.mobeiwsq.engine.widget.preview.KEY_SENSITIVITY";
    public static final String KEY_PROGRESS_COLOR = "com.mobeiwsq.engine.widget.preview.KEY_PROGRESS_COLOR";
    ...
    private void initArgs() {
        ...
        if (bundle != null) {
            int colorId = bundle.getInt(KEY_PROGRESS_COLOR, R.color.config_color_main_theme);
            mLoadingView.setSupportIndeterminateTintList(ResUtils.INSTANCE.getColors(getContext(), colorId));
