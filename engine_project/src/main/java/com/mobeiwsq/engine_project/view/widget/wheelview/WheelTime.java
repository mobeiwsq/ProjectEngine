package com.mobeiwsq.engine_project.view.widget.wheelview;

import android.view.View;
import com.mobeiwsq.engine_project.R;
import com.mobeiwsq.engine_project.utils.ChinaDateUtils;
import com.mobeiwsq.engine_project.utils.LunarCalendarUtils;
import com.mobeiwsq.engine_project.view.widget.adapter.ArrayWheelAdapter;
import com.mobeiwsq.engine_project.view.widget.timer.listener.ISelectTimeCallback;
import com.mobeiwsq.engine_project.view.widget.wheelview.adapter.NumericWheelAdapter;
import com.mobeiwsq.engine_project.view.widget.wheelview.listener.OnItemSelectedListener;
...
//                maxItem = endD;
    ...
    public void setLabels(String label_year, String label_month, String label_day, String label_hours, String label_mins, String label_seconds) {
        ...
        if (label_year != null) {
            ...
            wv_year.setLabel(view.getContext().getString(R.string.picker_view_year));
        }
        if (label_month != null) {
            wv_month.setLabel(label_month);
        } else {
            wv_month.setLabel(view.getContext().getString(R.string.picker_view_month));
        }
        if (label_day != null) {
            wv_day.setLabel(label_day);
        } else {
            wv_day.setLabel(view.getContext().getString(R.string.picker_view_day));
        }
        if (label_hours != null) {
            wv_hours.setLabel(label_hours);
        } else {
            wv_hours.setLabel(view.getContext().getString(R.string.picker_view_hours));
        }
        if (label_mins != null) {
            wv_minutes.setLabel(label_mins);
        } else {
            wv_minutes.setLabel(view.getContext().getString(R.string.picker_view_minutes));
        }
        if (label_seconds != null) {
            wv_seconds.setLabel(label_seconds);
        } else {
            wv_seconds.setLabel(view.getContext().getString(R.string.picker_view_seconds));
        }
