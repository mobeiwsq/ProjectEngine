 ...
 *
 */
public class EnginePopup extends EngineBasePopup {
    ...
    public EnginePopup(Context context, int preferredDirection) {
        super(context);
     ...
     * 设置根据计算得到的位置后的偏移值
     */
    public EnginePopup setPositionOffsetX(int offsetX) {
        mOffsetX = offsetX;
        return this;
    }
     ...
     */
    public EnginePopup setPositionOffsetYWhenTop(int offsetYWhenTop) {
     ...
     */
    public EnginePopup setPositionOffsetYWhenBottom(int offsetYWhenBottom) {
     ...
     * @return
     */
    public EnginePopup setPreferredDirection(int preferredDirection) {
        mPreferredDirection = preferredDirection;
        return this;
    }
    ...
    private void initAnimationStyle(int screenWidth, int requestedX) {
        ...
        switch (mAnimStyle) {
            case ANIM_GROW_FROM_LEFT:
                getPopupWindow().setAnimationStyle(onTop ? R.style.Engine_Animation_PopUpMenu_Left : R.style.Engine_Animation_PopDownMenu_Left);
                break;

            case ANIM_GROW_FROM_RIGHT:
                getPopupWindow().setAnimationStyle(onTop ? R.style.Engine_Animation_PopUpMenu_Right : R.style.Engine_Animation_PopDownMenu_Right);
                break;

            case ANIM_GROW_FROM_CENTER:
                getPopupWindow().setAnimationStyle(onTop ? R.style.Engine_Animation_PopUpMenu_Center : R.style.Engine_Animation_PopDownMenu_Center);
                break;
            case ANIM_AUTO:
    ...
    public void setContentView(View root) {
        FrameLayout container = (FrameLayout) LayoutInflater.from(getContext()).inflate(R.layout.layout_popup, null, false);
    ...
    public void showDown(View v) {
        setPreferredDirection(EnginePopup.DIRECTION_BOTTOM);
        show(v);
    }
    ...
    public void showUp(View v) {
        setPreferredDirection(EnginePopup.DIRECTION_TOP);
        show(v);
    }
    ...
    protected int getPopupWidth() {
        return Utils.getDimensionPixelSize(getContext(), R.dimen.popup_width);
    }
