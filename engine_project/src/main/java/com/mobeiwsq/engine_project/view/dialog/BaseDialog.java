...
package com.mobeiwsq.engine_project.view.dialog;
...
import com.mobeiwsq.engine_project.utils.WidgetUtils;
...
public class BaseDialog extends AppCompatDialog {
    ...
    public BaseDialog(Context context, int layoutId) {
        this(context, R.style.EngineDialog_Custom, layoutId);
    }

    public BaseDialog(Context context, View contentView) {
        this(context, R.style.EngineDialog_Custom, contentView);
    }

    public BaseDialog(Context context) {
        super(context, R.style.EngineDialog_Custom);
    }
    ...
    public Drawable getDrawable(int resId) {
        return ResUtils.INSTANCE.getDrawable(getContext(), resId);
    }
