...
import com.mobeiwsq.engine_project.utils.PickerViewAnimateUtils;
import com.mobeiwsq.engine_project.utils.ThemeUtils;
import com.mobeiwsq.engine_project.utils.Utils;
import com.mobeiwsq.engine_project.view.widget.listener.OnDismissListener;
...
public class BasePickerView {
    ...
    protected void initViews() {
        ...
        if (isDialog()) {
            //如果是对话框模式
            dialogView = (ViewGroup) layoutInflater.inflate(R.layout.layout_picker_view_base, null, false);
            //设置界面的背景为透明
            ...
            //将控件添加到decorView中
            rootView = (ViewGroup) layoutInflater.inflate(R.layout.layout_picker_view_base, mPickerOptions.decorView, false);
    ...
    public void createDialog() {
        if (dialogView != null) {
            mDialog = new Dialog(context, R.style.EngineDialog_Custom);
    ...
    private void setWindowMaxWidth(Window dialogWindow) {
        ...
        int windowHorizontalPadding = ThemeUtils.resolveDimension(context, R.attr.md_dialog_horizontal_margin,
                Utils.getDimensionPixelSize(context, R.dimen.default_md_dialog_horizontal_margin_phone));
